(() => {
    ...
    function initSliders() {
        if (document.querySelector(".top-main-slider")) new core(".top-main-slider", {
    ...
    const menuBack = document.querySelector(".mobile-menu__back");
    const callDropDownBody = document.querySelector(".dropdown-block-call__body");
    const callIconMenu = document.querySelector(".mobile-header-bar__call");
    const callBack = document.querySelector(".dropdown-block-call__back");
    const callDropClose = document.querySelector(".call-dropdown-close");
    const searchIcon = document.querySelector(".mobile-header-bar__search");
    const searchDropDown = document.querySelector(".search-dropdown-block__body");
    const searchIconClose = document.querySelector(".search-dropdown-close");
    ...
    callIconMenu.addEventListener("click", (() => {
        if (callDropDownBody.classList.contains("show")) {
            callDropDownBody.classList.remove("show");
            callBack.classList.remove("show");
            callIconMenu.classList.remove("color");
        } else {
            callDropDownBody.classList.add("show");
            callBack.classList.add("show");
            callIconMenu.classList.add("color");
        }
    }));
    callBack.addEventListener("click", (() => {
        if (callIconMenu.classList.contains("color")) callIconMenu.click(); else if (searchIcon.classList.contains("color")) searchIcon.click();
    }));
    callDropClose.addEventListener("click", (() => {
        callIconMenu.click();
    }));
    searchIcon.addEventListener("click", (() => {
        if (searchIcon.classList.contains("color")) {
